...
const postdata = [
  ...
  {
    title: 'Cajun Fries',
    post_url: '2 tablespoons olive oil, ½ teaspoon Cajun seasoning, ½ (18 ounce) package prepared polenta, cut into 3/4-inch wedges, salt to taste. Step 1: Preheat an air fryer to 356 degrees F (180 degrees C). Step 2: Combine oil and Cajun seasoning in a small bowl. Brush seasoned oil onto the polenta wedges with a pastry brush. Sprinkle lightly with salt. Place the wedges into the bowl of the air fryer, overlapping slightly if needed. Step 3: Cook in the preheated air fryer for 10 minutes. Flip carefully with a silicone spatula. Cook, shaking basket occasionally and using spatula if wedges stick, until crispy, 15 to 20 minutes more.',
    user_id: 1
  },
  {
    title: 'Fried Mashed Potato Cakes',
    post_url: '1 cup leftover mashed potatoes, cooled, 1 egg, 2 ½ tablespoons all-purpose flour, ¼ teaspoon salt, 1 tablespoon vegetable oil, or as needed. Step 1: Mix mashed potatoes, egg, flour, and salt together in a bowl. Step 2: Heat a thin layer of vegetable oil in a frying pan. Drop large spoonfuls of the potato mixture into the frying pan. Flatten into a patties as you flip; cook until browned on both sides, 6 to 7 minutes per cake. Repeat with remaining potato mixture.',
    user_id: 2
  },
  {
